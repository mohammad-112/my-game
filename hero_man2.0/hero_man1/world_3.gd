...
func _ready():
	...
	# ✅ تعديل عدد الأرواح إلى 5 فقط في المرحلة الثالثة
	global.current_lives = 5
...
func _on_next_level_button_pressed():
	if has_node("/root/Global"):
		get_node("/root/Global").save_game()
	get_tree().change_scene_to_file("res://world_4.tscn")  # إذا عندك عالم رابع
